...
from src.ui.base_layout import style_theme_tokens, style_background_dashboard, style_base_layout
...
def teacher_screen_login():
    ...
    teacher_username = st.text_input("Enter username", placeholder='piyushgupta')
...
def teacher_screen_register():
    ...
    teacher_name = st.text_input("Enter name", placeholder='Piyush Gupta')
